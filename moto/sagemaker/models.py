...
from typing import Any, DefaultDict, Iterable, Optional, cast
...
class SageMakerModelBackend(BaseBackend):
    ...
    def create_trial_component(
        ...
        parameters: Optional[dict[str, dict[str, str | float]]],
    ...
    def _get_versioned_or_not(
        self, model_package_type: str | None, model_package_version: Optional[int]
    ) -> bool:
