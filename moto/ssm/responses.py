...
class SimpleSystemManagerResponse(BaseResponse):
    ...
    def delete_parameter(self) -> str | tuple[str, dict[str, int]]:
        name = self._get_param("Name")
    ...
    def get_parameter(self) -> str | tuple[str, dict[str, int]]:
        name = self._get_param("Name")
    ...
    def put_parameter(self) -> str | tuple[str, dict[str, int]]:
        name = self._get_param("Name")
    ...
    def get_parameter_history(self) -> str | tuple[str, dict[str, int]]:
        name = self._get_param("Name")
        with_decryption = self._get_param("WithDecryption")
